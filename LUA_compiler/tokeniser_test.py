...
# test_exp("not 5", tokeniser.TokenType.UNARY_EXPRESSION)
# test_exp("-5", tokeniser.TokenType.UNARY_EXPRESSION)
# test_exp("#a", tokeniser.TokenType.UNARY_EXPRESSION)
# test_exp("~0b0000", tokeniser.TokenType.UNARY_EXPRESSION)

#test_exp("1 + 2", tokeniser.TokenType.UNARY_EXPRESSION)
